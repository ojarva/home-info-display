...
class ServerPowerPublisher(object):
    ...
    def __init__(self):
        ...
        self.sp = manage_server_power.ServerPower(server_hostname=local_settings.SERVER_IP_ADDRESS, server_mac=local_settings.SERVER_MAC_ADDRESS,
                                                  ssh_username=local_settings.SERVER_SSH_USERNAME, broadcast_ip=local_settings.SERVER_BROADCAST_IP)
    ...
    def check_server_power(self):
        ...
        self.redis_instance.publish("home:broadcast:generic", json.dumps(
            {"key": "server_power", "content": {"status": status}}))
